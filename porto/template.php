...
function porto_form_alter(&$form, &$form_state, $form_id) {
  ...
  if ( TRUE === in_array( $form_id, array( 'user_login', 'user_login_block') ) )
     ...
     $form['name']['#attributes']['class'] = array('user');
     $form['pass']['#attributes']['class'] = array('password');
...
function porto_theme() {
   ...
   /**
    *Preprocess theme template for User Profile Edit page-
    */
 /* $items['user_profile_form'] = array(
     'template' => 'templates/user_profile_form',
     'render element' => 'form',
   );*/
   /**
    *Preprocess theme template for User login page-
    */
...
function porto_preprocess_user_login_block(&$vars) {
