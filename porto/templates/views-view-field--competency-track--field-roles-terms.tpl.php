...
$my_field = field_get_items('user', $curacc, 'field_roles_terms');
$values = [];
...
$final_output = "";
$matched = 0;
$data = $row->field_field_roles_terms;
$final_output .= '<div class="item-list" ><ul>';
foreach ($row->field_field_roles_terms as $output_item) {
	$li_class = "list-none";
...
if ($matched == count($row->field_field_roles_terms)) { //If all items are matched
?>
<style>
.view-competency-track td.views-field-field-roles-terms  {
